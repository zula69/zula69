...
I'm an undergraduate student specializing in Networking & Cybersecurity, driven by a passion for ethical hacking, penetration testing, and building practical security skills from the ground up. This space is where I document my journey — labs, projects, and experiments that shape me into a well-rounded security professional.
---
🎯 Objective
...
![Palo Alto](https://img.shields.io/badge/Palo_Alto-Networks-FF0000?style=for-the-badge&logo=paloalto&logoColor=white)
---
🚀 Projects
#	Project	Description	Link
01	Simple SQL Attack Simulation	Simulating and analyzing SQL injection attack vectors	→ View
---
🔬 Hack The Box Labs
#	Lab	Link
01	Meow — Starter Lab	→ View
02	Fawn — Starter Lab	→ View
03	Redeemer — Starter Lab	→ View
